...
/**
 * Multi-node integration test for the DMesh JNI bindings.
 *
 * <p>Creates multiple mesh nodes, connects them, and exercises
 * different communication paths: exec, stream callbacks, and
 * remote port forwarding.
 *
 * <p>Equivalent test programs exist in other languages — keep them in sync:
 * <ul>
 *   <li>Python: {@code tests/test_mesh.py}
 *   <li>Rust: {@code crates/ssh-mesh/tests/}
 * </ul>
 *
 * @see Main Production single-node launcher
 */
