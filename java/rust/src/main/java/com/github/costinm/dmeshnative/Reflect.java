...
/**
 * Helper for reflection - no longer useful for calling hidden android methods, but
 * still useful for FFI/scripting - to avoid generating boilerplate wrappers
 * for all public methods and to simplify the native side, avoiding JNI 
 * verbosity.
 * 
 * Should be equivalent with using the equivalent JNI calls.
 */
